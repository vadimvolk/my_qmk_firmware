...
[L_MAIN] = LAYOUT_ansi_84(
	...
	KC_TAB, 	KC_Q,   	KC_W,   	KC_E,  		KC_R,   	KC_T,   	KC_Y,   						KC_U,   	KC_I,   	KC_O,  		KC_P,   	KC_LBRC,	KC_RBRC, 				KC_BSLS,	TG(L_NEW_TAB),
...
[L_NEW_TAB] = LAYOUT_ansi_84(
	_______, 	_______,  	_______,  	_______, 	_______,	_______,  	_______,   						_______,  	_______,  	_______, 	_______, 	_______, 	_______, 	_______,	_______,	_______,
	_______, 	_______,  	_______,  	_______,  	_______,   	_______,   	_______,   						_______,   	_______,   	_______,  	_______,   	_______,	_______, 				_______,	MO(L_CONTROL),
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   						_______,   	_______,   	_______,  	_______,   	_______,	_______, 				_______,	TG(L_NEW_TAB),
	KC_HYPER,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   						_______,   	_______,   	_______,  	_______,	_______, 	 						_______,	_______,
	_______,				_______,   	_______,   	_______,  	_______,   	_______,   						_______,	_______, 	_______,	_______,	_______,				_______,	_______,	_______,
	_______,	_______,	_______,										LT(L_MEDIA_LAUNCHER, KC_SPC), 							_______,	_______,   	_______,				_______,	_______,    _______),
